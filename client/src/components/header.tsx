...
export function Header({ onMenuClick }: HeaderProps) {
  ...
  return (
    <div className="relative z-10 flex-shrink-0 flex h-16 bg-[hsl(var(--header))] text-foreground shadow border-b border-muted">
      <button
        type="button"
      ...
      <div className="flex-1 px-4 flex justify-between">
        ...
        <div className="ml-4 flex items-center md:ml-6">
          ...
          <Button
            variant="ghost"
            size="icon"
            className="ml-3 bg-muted text-muted-foreground hover:text-foreground rounded-full"
          >
